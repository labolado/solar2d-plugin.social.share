...
const char ShareLibrary::kName[] = "plugin.social.share";

// This corresponds to the event name, e.g. [Lua] event.name
const char ShareLibrary::kEvent[] = "pluginSocialShareEvent";
...
CORONA_EXPORT int luaopen_plugin_social_share( lua_State *L )
{
